...
export const PICTIONARY_ABI = {
  address: "0x6038c25eb61cf10831f50b3ba11006e3fef8a0cac0de6eeb4b57cdccfbec344f",
  name: "pictionary",
  friends: [],
  exposed_functions: [
    {
      ...
      is_view: false,
      generic_type_params: [],
      params: ["&signer", "vector<address>", "vector<address>", "u64", "u16", "u16", "u64"],
      return: [],
    },
    {
      name: "get_canvas",
  ...
  structs: [
    {
      ...
      fields: [
        {
          name: "pixels",
          type: "0x1::ordered_map::OrderedMap<u16, 0x6038c25eb61cf10831f50b3ba11006e3fef8a0cac0de6eeb4b57cdccfbec344f::pictionary::Color>",
        },
        {
          name: "width",
          type: "u16",
    ...
    },
    {
      ...
      fields: [
        ...
        {
          name: "color",
          type: "0x6038c25eb61cf10831f50b3ba11006e3fef8a0cac0de6eeb4b57cdccfbec344f::pictionary::Color",
        },
      ],
    },
    {
      ...
      fields: [
        ...
        {
          name: "deltas",
          type: "vector<0x6038c25eb61cf10831f50b3ba11006e3fef8a0cac0de6eeb4b57cdccfbec344f::pictionary::CanvasDelta>",
        },
        {
          name: "timestamp",
          type: "u64",
    ...
    },
    {
      ...
      fields: [
        ...
        {
          name: "rounds",
          type: "vector<0x6038c25eb61cf10831f50b3ba11006e3fef8a0cac0de6eeb4b57cdccfbec344f::pictionary::Round>",
        },
        {
          name: "started",
          type: "bool",
    ...
    },
    {
      ...
      fields: [
        ...
        {
          name: "team0_canvas",
          type: "0x6038c25eb61cf10831f50b3ba11006e3fef8a0cac0de6eeb4b57cdccfbec344f::pictionary::Canvas",
        },
        {
          name: "team1_canvas",
          type: "0x6038c25eb61cf10831f50b3ba11006e3fef8a0cac0de6eeb4b57cdccfbec344f::pictionary::Canvas",
